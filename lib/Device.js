 ...
 */
Device.prototype.ident = function (callback) {
...
Device.prototype.boxNames = function (callback) {
    return this._packageManager.send(116, null, function (data) {
...
Device.prototype.pidNames = function (callback) {
    return this._packageManager.send(117, null, function (data) {
        return data.toString().split(';').filter(function (value) {
            return value !== '';
        });
    }, callback);
